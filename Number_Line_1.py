...
class Main(Tk):
    ...
    def Draw_Basic(self):
        ...
        self.negative = Button(
            ...
            padx=5,
            command=lambda: self.func.click_btn("-"))
        self.negative.place(x=510, y=410)
